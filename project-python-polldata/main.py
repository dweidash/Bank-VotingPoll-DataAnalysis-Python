...
#Set-Up: import "os" to be able to notate relative directory pathways
    #create dirname so anyone that downloads this repository can use this file without errors.
import os
dirname = os.path.dirname(__file__)


#Set-Up: Set variable csvpath to the pathway to our csv file containing our data. PLEASE NOTE that we're using os.path.join(dirname,) to access a pathway notation for the data file.
...
with open(csvpath,newline='') as csvfile:
    ...
    #skip the header, and don't forget it!
    next(csvreader)
...
#First part is to set the path to the file to a specific variable. PLEASE NOTE that we're using os.path.join(dirname,) to access a pathway notation to create the text file.
exportPath = os.path.join(dirname, "election_analysis.txt")
